...
import 'package:groupcalling/homepage.dart';
...
class _CallPageState extends State<CallPage> {
  ...
  bool loading = false;
  String appId = 'be158bd872034b88b34879ab67680917';
  ...
  Future<void> initializeAngora() async {
    setState(() {
      loading = true;
    });
      ...
      if (_remoteUids.length == 1) {
        ...
        return Column(
          children: [
            ...
            RtcRemoteView.SurfaceView(
                uid: _remoteUids[2], channelId: widget.channelName),
          ],
        );
      } else {
        return SizedBox(
